  ...
  return {
    ...
    candidate: {
      ...
      adapterCoverage: {
        ...
        unsupportedRuntimes: ['claude-agent-sdk', 'claude-code-cli', 'claude-code-local', 'codex', 'cursor-cli', 'grok', 'gemini', 'copilot', 'kiro-cli', 'q', 'ollama'],
      },
    ...
    runtimeCoverage: {
      allRuntimes: ['claude-agent-sdk', 'claude-code-cli', 'claude-code-local', 'codex', 'cursor-cli', 'grok', 'gemini', 'copilot', 'kiro-cli', 'q', 'ollama'],
      pluginRuntimes: ['claude-agent-sdk', 'claude-code-cli', 'claude-code-local'],
      portablePluginRuntimes: ['claude-agent-sdk', 'claude-code-cli', 'claude-code-local', 'codex', 'cursor-cli', 'grok', 'gemini', 'copilot', 'kiro-cli', 'q', 'ollama'],
      mcpRuntimes: ['claude-agent-sdk', 'claude-code-cli', 'claude-code-local', 'codex', 'grok', 'gemini', 'copilot', 'kiro-cli', 'q', 'ollama'],
      directFallbackRuntimes: ['claude-agent-sdk', 'claude-code-cli', 'claude-code-local', 'codex', 'cursor-cli', 'grok', 'gemini', 'copilot', 'kiro-cli', 'q', 'ollama'],
      pluginOnlyWouldExclude: ['codex', 'cursor-cli', 'grok', 'gemini', 'copilot', 'kiro-cli', 'q', 'ollama'],
    },
    modeMatrix: [
