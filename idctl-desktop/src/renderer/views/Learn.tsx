          ...
          {selected ? (
            <div className="stack">
              ...
              <div className="kv" style={{ gridTemplateColumns: '92px 1fr', gap: '6px 12px' }}>
                ...
                <span title={selected.brainSync ? `entity=${selected.brainSync.entity}; facts=${selected.brainSync.facts}; edges=${selected.brainSync.edgeCount ?? 0}/${selected.brainSync.expectedEdgeCount ?? 0}; text=${selected.brainSync.text}; memory=${selected.brainSync.memory}; timeline=${selected.brainSync.timeline}` : 'No Brain sync result recorded yet'}>
