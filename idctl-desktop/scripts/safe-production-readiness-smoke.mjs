...
assert.match(main, /const GUARDED_EVM_READ_METHODS = new Set\(\['eth_call', 'eth_getCode', 'eth_getTransactionReceipt'\]\)/);
assert.match(main, /case 'evmRpc:read'/);
assert.match(identity, /call<string>\('evmRpc:read'/);
